...
export default function useHomePage() {
  ...
  const submitRegister = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8188/userpage/user/register', payload)
  ...
  const submitLogin = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8188/userpage/user/login', payload, {
        headers: {
