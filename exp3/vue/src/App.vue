<template>
  <div class="home-page">
    ...
    <div class="container background-top">
      <div class="row mx-5">
        ...
        <div class="col d-flex justify-content-end">
          <button class="btn btn-transparent mx-3 mt-2" type="button" @click="openLogin">
            登录
          </button>
          <button class="btn btn-transparent mt-2" type="button" @click="openRegister">注册</button>
        </div>
      </div>
      ...
      <div class="row mt-2">
        <div class="col text-center">
          <h5 class="white-text">软件定义一切，网络连接时空，学习软件技术，创造未来世界。</h5>
        </div>
      </div>

      <div class="row mt-5">
        <div class="col text-center">
          <button type="button" class="btn btn-lg btn-learn-right-now" @click="jumpReact">
            马上学习
          </button>
        </div>
      </div>
    ...
    <div class="container background-grey">
      ...
      <div class="ms-5 pb-5">
        <button type="button" class="btn btn-grey" @click="jumpReact">了解详情</button>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="my-4 ms-5">
        <h5>双屏学习，小屏视频互动，大屏实际操作，学习无障碍。打开浏览器，即刻开始编程！</h5>
      </div>
      <div class="ms-5 pb-5">
        <button type="button" class="btn btn-grey" @click="jumpReact">了解详情</button>
      </div>
    ...
    <!-- 页脚 -->
    <div class="container background-grey">
      <div class="mx-5 mt-5 py-4 text-center">©2024 云端科技 Artech All rights reserved</div>
    </div>
    ...
    <ModalDialog :show="showRegister" title="注册" @close="closeRegisterWindow">
      <div class="container">
        ...
        <div class="row mt-3">
          <div class="col">
            <button class="btn btn-primary" @click="submitRegister" :disabled="isLoading">
              {{ isLoading ? '注册中...' : '注册' }}
            </button>
    ...
    <ModalDialog :show="showLogin" title="登录" @close="closeLoginWindow">
      <div class="container">
        ...
        <div class="row mt-3">
          <div class="col">
            <button class="btn btn-primary" @click="submitLogin" :disabled="isLoading">
              {{ isLoading ? '登录中...' : '登录' }}
            </button>
            <button class="btn btn-secondary ms-4" @click="reset">重置</button>
          </div>
        ...
        <div class="row mt-3">
          <div class="col">
            <u @click="jumpToRegisterWindow" class="blue-text">没有账号？立即注册！</u>
          </div>
        </div>
        <div class="row mt-3" v-if="message">
          <div class="col text-center">
